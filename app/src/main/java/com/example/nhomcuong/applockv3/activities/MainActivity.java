...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, TransferData, SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Log.e("CUONG", "Co Phai la appLock khong" + dataUse.getisAppLock());
        ...
        noResults = (LinearLayout) findViewById(R.id.no_result);
    ...
    public boolean onQueryTextChange(String search) {
        if (search.isEmpty()) {
            ...
            adapter.getFilter().filter(search.toLowerCase());
        }
