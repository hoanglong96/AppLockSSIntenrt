...
public class CreateChangePassPatternActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_pass_pattern);
                            ...
                            if (PatternLockUtils.patternToString(mPatternLockView, event.getPattern()).length() < 4) {
                                ...
                                btnContinue.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        // vao app
                                        Intent intent = new Intent(getApplicationContext(), ReChangePasswordPatternActivity.class);
