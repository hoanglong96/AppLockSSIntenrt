...
import com.example.nhomcuong.applockv3.changepassword.CreateChangePassIntegerActivity;
...
public class SettingActivity extends AppCompatActivity {
    ...
    CardView cvPassPattern,cvPassInterNumber,cvPassText,cvFinger;
    DataUse dataUse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvPassInterNumber = (CardView) findViewById(R.id.type_pass_number);
        ...
        cvPassInterNumber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dataUse.setLockMode("enterintpass");
                Intent intent = new Intent(SettingActivity.this, CreateChangePassIntegerActivity.class);
                startActivity(intent);
                finish();
            }
        });
